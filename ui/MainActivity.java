    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listThingsBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                String urlstr = listThingsURL.getText().toString(); // 사물목록 조회 API URL을 읽어와 urlstr 초기화
                ...
                intent.putExtra("listThingsURL", listThingsURL.getText().toString()); // url 정보를 파라미터로 넘겨준다
        ...
        thingShadowBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String urlstr = thingShadowURL.getText().toString(); // 사물상태 조회/변경 API URL을 읽어와 urlStr 초기화
                if (urlstr == null || urlstr.equals("")) {
        ...
        listLogsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String urlstr = getLogsURL.getText().toString(); // 로그 조회 API URL을 읽어와 urlStr 초기화
                if (urlstr == null || urlstr.equals("")) {
