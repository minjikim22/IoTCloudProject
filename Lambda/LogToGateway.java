...
//dynamoDB를 API gateway와 연결하는 람다함수
...
public class LogToGateway implements RequestHandler<Event, String> {

    private DynamoDB dynamoDb;
    private String DYNAMODB_TABLE_NAME = "FinalDB"; //생성한 dynamoDB의 이름
    ...
    public String handleRequest(Event input, Context context) {
        ...
        QuerySpec querySpec = new QuerySpec()
        		//파티션키 DeviceID와 정렬키 timestamp값을 읽어준다.
                .withKeyConditionExpression("DeviceID = :v_id and #t between :from and :to")
                .withNameMap(new NameMap().with("#t", "timestamp"))
